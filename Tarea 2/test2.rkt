...
(test (defs-contain? (list (cons 'x (real 3)) (cons 'y (real 4))) 'x) #t)
(test (defs-contain? (list (cons 'x (real 3)) (cons 'y (real 4))) 'z) #f)

(test (subst-defs (list (cons 'x (real 3)) (cons 'y (id 'z))) 'z (real 3)) (list (cons 'x (real 3)) (cons 'y (real 3))))
(test (subst-defs (list (cons 'x (real 3)) (cons 'y (id 'z))) 'f (real 3)) (list (cons 'x (real 3)) (cons 'y (id 'z))))
...
(test/exn (interp (with (list (cons 'x (real 3)) (cons 'y (id 'x)) (cons 'z (id 'x))) (add (id 'x) (add (id 'y) (id 'f))))) "interp: free identifier")
